...
"""
class Point:
    """A distance from skipper.a relative origin (0, 0)."""
    
    def __init__(self, x = 0, y = 0):
        """Constructs a new Point using the specified x and y values.
        
        Args:
            x: An int representing the horizontal distance from skipper.the origin.
            y: An int representing the vertical distance from skipper.the origin.
        """
        self._x = x
        self._y = y
